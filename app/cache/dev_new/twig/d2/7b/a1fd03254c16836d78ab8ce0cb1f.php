...
/* CompeteComBundle:Competitions:new.html.twig */
class __TwigTemplate_d27ba1fd03254c16836d78ab8ce0cb1f extends Twig_Template
{
    ...
    {
        // line 4
        echo "<h1>Competitions creation</h1>

    <form action=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("competitions_create"), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "CompeteComBundle:Competitions:new.html.twig";
    }
