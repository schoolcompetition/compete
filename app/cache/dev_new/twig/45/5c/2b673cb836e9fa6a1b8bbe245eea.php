...
/* CompeteComBundle:TournamentQuestions:edit.html.twig */
class __TwigTemplate_455c2b673cb836e9fa6a1b8bbe245eea extends Twig_Template
{
    ...
    {
        // line 4
        echo "<h1>TournamentQuestions edit</h1>

    <form action=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("tournamentquestions_update", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "CompeteComBundle:TournamentQuestions:edit.html.twig";
    }
