...
/* CompeteComBundle:TournamentQuestions:index.html.twig */
class __TwigTemplate_dbf8ad8ee1994e7c34dc39ef90c491aa extends Twig_Template
{
    ...
    {
        // line 4
        echo "<h1>TournamentQuestions list</h1>
    ...
    <table class=\"records_list\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "            <tr>
                <td><a href=\"";
            // line 20
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("tournamentquestions_show", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
            echo "\">";
        ...
        <li>
            <a href=\"";
        // line 42
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("tournamentquestions_new"), "html", null, true);
        echo "\">
                Create a new entry
            </a>
        </li>
    ...
    {
        return "CompeteComBundle:TournamentQuestions:index.html.twig";
    }
