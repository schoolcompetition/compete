...
/* CompeteComBundle:Competitions:edit.html.twig */
class __TwigTemplate_b18fcb4366a1d9274ad5219dc0ef40d1 extends Twig_Template
{
    ...
    {
        // line 4
        echo "<h1>Competitions edit</h1>

    <form action=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("competitions_update", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "CompeteComBundle:Competitions:edit.html.twig";
    }
