 ...
 */
class SubjComp extends \Compete\ComBundle\Entity\SubjComp implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'subj', 'comp');
    }
