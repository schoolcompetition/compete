 ...
 */
class RightAnswers extends \Compete\ComBundle\Entity\RightAnswers implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setAns($ans);
    }

    public function getAns()
    {
        $this->__load();
        return parent::getAns();
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'approved', 'q', 'ans');
    }
